class Question {
  ...
  display(){
    ...
    this.question.html("What is my favourite cartoon ")
    this.question.position(350, 50);

    this.option1.html("a. Tom and Jerry")
    this.option2.html("b. scooby-doo")
    this.option3.html("c. Avatar")
    this.option4.html("d. Teen titans go")
